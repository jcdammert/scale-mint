          ...
          >
            ...
            <div className="card-glass p-8 md:p-10">
              <p className="text-base leading-relaxed text-muted-foreground">
                Scale plan clients who are already getting some leads and want to pour fuel on the fire. <span className="text-foreground font-medium">Minimum $750–$1,500/mo ad spend recommended, depending on industry.</span>
              </p>
            </div>
          </motion.div>
        </div>
